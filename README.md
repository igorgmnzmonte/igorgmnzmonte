...
* 👾 **[Porygon-Lab](https://github.com/Jose-Carlos-Abreu/porygon-lab)**: Aplicação Web Full-Stack (Pokédex) construída com **Python (Flask)**. Conta com sistema de autenticação, favoritos e gerenciamento de times de usuários. Projeto desenvolvido em equipe, utilizando arquitetura em camadas, modelagem UML e versionamento com Git/GitHub.
